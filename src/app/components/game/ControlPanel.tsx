        ...
        <>
          ...
          {showFinishConfirmation && (
            <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
              <div className="bg-gradient-to-br from-gray-800 to-gray-900 border-4 border-red-500 rounded-2xl p-8 max-w-md w-full shadow-2xl">
                ...
                <div className="flex gap-4">
                  <button
                    onClick={cancelFinishGame}
                    className="flex-1 bg-gradient-to-r from-gray-600 to-gray-500 hover:from-gray-700 hover:to-gray-600 text-white font-bold py-3 px-4 rounded-xl transition-all border-2 border-gray-400"
                  >
                    Anuluj
                  </button>
                  <button
                    onClick={confirmFinishGame}
                    className="flex-1 bg-gradient-to-r from-red-600 to-red-500 hover:from-red-700 hover:to-red-600 text-white font-bold py-3 px-4 rounded-xl transition-all border-2 border-red-400"
                  >
                    Zakończ
                  </button>
                </div>
